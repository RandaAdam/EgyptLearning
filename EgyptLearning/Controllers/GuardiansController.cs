...
namespace EgyptLearning.Controllers
{
    public class GuardiansController : Controller
    {
        ...
        {
            var guardians = db.Guardians.Include(g => g.Student);
        ...
        public ActionResult Create([Bind(Include = "StudentID,Name,Street,City")] Guardian guardian)
        {
            ...
            ViewBag.StudentID = new SelectList(db.Students, "StudentID", "FirstName", guardian.StudentID);
            return View(guardian);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,Name,Street,City")] Guardian guardian)
        {
            if (ModelState.IsValid)
            {
